      ...
      <div style={{ marginBottom: '40px', display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end', flexWrap: 'wrap', gap: '20px' }}>
        <div>
          <h1 style={{ fontSize: '2.5rem', fontWeight: 900, marginBottom: '8px', letterSpacing: '-1px' }}>
            ANÁLISE APROFUNDADA DO <span className="gradient-text">QUESTIONÁRIO</span>
          </h1>
          <p style={{ color: 'var(--text-muted)' }}>Insights detalhados cruzando respostas com IAs selecionadas (Modo Leitura Pública).</p>
        </div>
